...
const projects = [
  {
    title: 'FlixMovies',
    description: 'A movie discovery platform built with React. It includes UX design and frontend implementation.',
    image: 'https://woz-u.com/wp-content/uploads/2022/06/Evolution-of-Coding-scaled.jpg',
    tags: ['React', 'TypeScript', 'Tailwind CSS', 'IMDB - Rest API', 'Figma', 'UX Design'],
    category: 'frontend',
    featured: true
  },
  {
    ...
    image: 'https://woz-u.com/wp-content/uploads/2022/06/Evolution-of-Coding-scaled.jpg',
    tags: ['React', 'TypeScript', 'SCSS', 'Hugging Face - Models & API'],
    category: 'frontend',
    featured: false
  },
  {
