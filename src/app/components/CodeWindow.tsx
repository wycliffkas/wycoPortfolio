...
export function CodeWindow() {
  ...
  title: 'Full Stack Engineer | Frontend Engineer | Problem Solver',
  skills: [
        ...
        <div className="p-6 font-mono text-sm overflow-x-auto">
          <pre className="text-gray-300">
            <code>
              ...
              <span className="text-[#ff6b9d]">:</span>{" "}
              <span className="text-[#2cb67d]">'Wycliff Kasirye'</span>
              ...
              <span className="text-gray-500">,</span>{" "}
              <span className="text-[#2cb67d]">'Python'</span>
              <span className="text-gray-500">,</span>
              {"\n"}
              {"    "}
              <span className="text-[#2cb67d]">'React'</span>
              <span className="text-gray-500">,</span>{" "}
              <span className="text-[#2cb67d]">'React Native'</span>
              <span className="text-gray-500">,</span>{" "}
              <span className="text-[#2cb67d]">'Vue'</span>
              <span className="text-gray-500">,</span> {"\n"}
              {"    "}
              ...
              <span className="text-gray-500">,</span>{" "}
              <span className="text-[#2cb67d]">'Material UI'</span>
              <span className="text-gray-500">,</span>{" "}
              ...
              <span className="text-gray-500">,</span>{" "}
              <span className="text-[#2cb67d]">'GraphQL'</span>
              <span className="text-gray-500">,</span>{" "}
              <span className="text-[#2cb67d]">'React Query'</span>
              <span className="text-gray-500">,</span>
              {"\n"}
              {"    "}
              <span className="text-[#2cb67d]">'PostgreSQL'</span>
              <span className="text-gray-500">,</span>{" "}
              ...
              <span className="text-gray-500">,</span>{" "}
              <span className="text-[#2cb67d]">'Docker'</span>
              <span className="text-gray-500">,</span>{" "}
              <span className="text-[#2cb67d]">'AWS'</span>
              <span className="text-gray-500">,</span>{" "}
