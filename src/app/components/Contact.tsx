...
export function Contact() {
  ...
  const handleFormSubmit = (event) => {
    ...
    emailjs
      .sendForm(
        "service_znlxx0v", // Replace with your EmailJS Service ID
        "template_zrvz78b", // Replace with your EmailJS Template ID
        event.target,
        "6Goez6ZnwfBRiGcwM" // Replace with your EmailJS User ID
      )
      .then(
        (result) => {
              ...
              <CardContent sx={{ p: 4 }}>
                <Box
                  ...
                  <Button
                    ...
                    sx={{
                      background:
                        "linear-gradient(90deg, #ff6b9d, #7f5af0, #4ecdc4)",
                      textTransform: "none",
                      py: 1.5,
                      fontSize: "1rem",
                      borderRadius: "10px",
                      ...
                      "&:hover": {
                        background:
                          "linear-gradient(90deg, #ff5086, #6a3fd9, #3fb8ae)",
